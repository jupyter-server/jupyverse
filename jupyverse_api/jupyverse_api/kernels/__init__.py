...
class Kernels(Router, ABC):
    def __init__(self, app: App, auth: Auth, kernels_config: KernelsConfig):
        super().__init__(app=app)

        if kernels_config.include_router:
            router = APIRouter()
            ...
            self.include_router(router, prefix=kernels_config.prefix)
